...
### Table S8. ORA_mPFC_celltype_upregulated.xlsx
...
write_xlsx(ego_tbl, "Table S8. ORA_mPFC_celltype_upregulated.xlsx")
```

### Table S9. ORA_mPFC_celltype_downregulated.xlsx
...
write_xlsx(ego_tbl, "Table S9. ORA_mPFC_celltype_downregulated.xlsx")
```
