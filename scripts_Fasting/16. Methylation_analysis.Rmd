...
region_stats <- function(se,
  ...
  mat     <- assay(se, assay_name) # probe × sample
  meta    <- as.data.frame(colData(se))
...
### Table S10. Significance of PCs in separating experimental variables.xlsx
...
write_xlsx(PC_res, path = file.path(result_folder, "Table S10. Significance of PCs in separating experimental variables.xlsx"))
```
...
### Table S11. PC2_1pct_high_loading_probes.xlsx
...
write_xlsx(
  ...
  path = "Table S11. PC2_1pct_high_loading_probes.xlsx"
)
```
...
### Table S12. ORA_of_high-loading_probes.xlsx
...
write_xlsx(res_go_tables, path = file.path(result_folder, "Table S12. ORA_of_high-loading_probes.xlsx"))
```
